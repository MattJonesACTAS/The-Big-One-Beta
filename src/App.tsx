              ...
              {catchupStep === 6 && (
                <div className="space-y-6 px-4 max-w-md mx-auto">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      {/* Zoll-style CPR timer display — purple bar, white border, black text */}
                      <div style={{ background: '#8b8fc7', border: '2px solid white', borderRadius: '0', padding: '10px 16px' }}>
