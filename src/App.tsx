  ...
  return (
              ...
              {catchupStep === 6 && (
                <div className="space-y-6 px-4 max-w-md mx-auto">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    >
                      <div style={{ background: '#309959', padding: '10px 16px', minHeight: '58px', display: 'flex', alignItems: 'center' }}>
    ...
    <rect x="8" y="1" width="6" height="4" rx="1" fill="white"/>
                    ...
                    >
                      ...
                      <div style={{ background: '#9690cc', padding: '10px 16px', minHeight: '58px', display: 'flex', alignItems: 'center' }}>
                        <div className="flex items-center justify-between">
